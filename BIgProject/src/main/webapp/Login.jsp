...
<div class="wrapper fadeInDown">
    <div id="formContent">
        <div class="fadeIn first">
            ...
            <img src="https://cdn-icons-png.flaticon.com/512/2474/2474450.png" id="icon" alt="User Icon" />
            <div style="font-family: LakkiReddy" class="fontSize">Login</div>
        </div>
        ...
        <div id="formFooter">
            <a class="underlineHover" href="emailEditForm.jsp">Forgot Password?</a>
            <p style="color: red;font-size: 10px;">${messageLoginF}</p>
